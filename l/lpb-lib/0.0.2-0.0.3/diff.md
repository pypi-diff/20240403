# Comparing `tmp/lpb_lib-0.0.2.tar.gz` & `tmp/lpb_lib-0.0.3.tar.gz`
...
## Comparing `lpb_lib-0.0.2.tar` & `lpb_lib-0.0.3.tar`
...
### Comparing `lpb_lib-0.0.2/PKG-INFO` & `lpb_lib-0.0.3/PKG-INFO`
...
### Comparing `lpb_lib-0.0.2/setup.cfg` & `lpb_lib-0.0.3/setup.cfg`
...
### Comparing `lpb_lib-0.0.2/src/lpb_lib.egg-info/PKG-INFO` & `lpb_lib-0.0.3/src/lpb_lib.egg-info/PKG-INFO`
