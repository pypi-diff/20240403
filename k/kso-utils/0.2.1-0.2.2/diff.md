# Comparing `tmp/kso_utils-0.2.1.tar.gz` & `tmp/kso_utils-0.2.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "kso_utils-0.2.1.tar", max compression
+gzip compressed data, was "kso_utils-0.2.2.tar", max compression
```

## Comparing `kso_utils-0.2.1.tar` & `kso_utils-0.2.2.tar`

### file list

```diff
@@ -1,25 +1,25 @@
--rw-r--r--   0        0        0    35126 2023-09-21 14:24:50.986126 kso_utils-0.2.1/LICENSE
--rw-r--r--   0        0        0    14312 2024-04-02 13:24:27.140946 kso_utils-0.2.1/README.md
--rw-r--r--   0        0        0        0 2023-09-21 14:24:50.996729 kso_utils-0.2.1/kso_utils/__init__.py
--rw-r--r--   0        0        0        0 2023-09-21 14:24:50.996795 kso_utils-0.2.1/kso_utils/db_starter/__init__.py
--rw-r--r--   0        0        0     1079 2024-04-02 13:24:18.424978 kso_utils-0.2.1/kso_utils/db_starter/cdn_projects_list.csv
--rw-r--r--   0        0        0     1461 2024-02-28 09:49:51.234739 kso_utils-0.2.1/kso_utils/db_starter/projects_list.csv
--rw-r--r--   0        0        0     1994 2024-04-02 13:24:18.425126 kso_utils-0.2.1/kso_utils/db_starter/schema.py
--rw-r--r--   0        0        0    17893 2024-04-02 13:24:18.425340 kso_utils-0.2.1/kso_utils/db_utils.py
--rw-r--r--   0        0        0     6741 2024-04-02 13:24:18.426034 kso_utils-0.2.1/kso_utils/frame_utils.py
--rw-r--r--   0        0        0     4091 2023-09-22 19:06:03.217864 kso_utils-0.2.1/kso_utils/general.py
--rw-r--r--   0        0        0    13317 2024-04-02 13:24:18.426336 kso_utils-0.2.1/kso_utils/koster_utils.py
--rw-r--r--   0        0        0    31563 2024-04-02 13:24:18.426758 kso_utils-0.2.1/kso_utils/movie_utils.py
--rw-r--r--   0        0        0    95930 2024-04-02 13:24:18.427610 kso_utils-0.2.1/kso_utils/project.py
--rw-r--r--   0        0        0     3606 2024-04-02 13:24:18.428216 kso_utils-0.2.1/kso_utils/project_utils.py
--rw-r--r--   0        0        0    14924 2024-04-02 13:24:18.428542 kso_utils-0.2.1/kso_utils/server_utils.py
--rw-r--r--   0        0        0     6295 2024-04-02 13:24:18.429109 kso_utils-0.2.1/kso_utils/sgu_utils.py
--rw-r--r--   0        0        0    10031 2024-04-02 13:24:18.429517 kso_utils-0.2.1/kso_utils/spyfish_utils.py
--rw-r--r--   0        0        0    13795 2024-04-02 13:24:18.430086 kso_utils-0.2.1/kso_utils/video_reader.py
--rw-r--r--   0        0        0    76147 2024-04-02 13:24:18.430796 kso_utils-0.2.1/kso_utils/widgets.py
--rw-r--r--   0        0        0    80905 2024-04-02 15:03:44.770676 kso_utils-0.2.1/kso_utils/yolo_utils.py
--rw-r--r--   0        0        0     3347 2023-09-21 14:24:50.998838 kso_utils-0.2.1/kso_utils/zenodo_utils.py
--rw-r--r--   0        0        0    85468 2024-04-02 13:24:18.432485 kso_utils-0.2.1/kso_utils/zooniverse_utils.py
--rw-r--r--   0        0        0     2535 2024-04-03 11:50:12.800675 kso_utils-0.2.1/pyproject.toml
--rw-r--r--   0        0        0    15784 1970-01-01 00:00:00.000000 kso_utils-0.2.1/setup.py
--rw-r--r--   0        0        0    15879 1970-01-01 00:00:00.000000 kso_utils-0.2.1/PKG-INFO
...
### Comparing `kso_utils-0.2.1/LICENSE` & `kso_utils-0.2.2/LICENSE`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/README.md` & `kso_utils-0.2.2/README.md`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/db_starter/cdn_projects_list.csv` & `kso_utils-0.2.2/kso_utils/db_starter/cdn_projects_list.csv`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/db_starter/projects_list.csv` & `kso_utils-0.2.2/kso_utils/db_starter/projects_list.csv`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/db_starter/schema.py` & `kso_utils-0.2.2/kso_utils/db_starter/schema.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/db_utils.py` & `kso_utils-0.2.2/kso_utils/db_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/frame_utils.py` & `kso_utils-0.2.2/kso_utils/frame_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/general.py` & `kso_utils-0.2.2/kso_utils/general.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/koster_utils.py` & `kso_utils-0.2.2/kso_utils/koster_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/movie_utils.py` & `kso_utils-0.2.2/kso_utils/movie_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/project.py` & `kso_utils-0.2.2/kso_utils/project.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/project_utils.py` & `kso_utils-0.2.2/kso_utils/project_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/server_utils.py` & `kso_utils-0.2.2/kso_utils/server_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/sgu_utils.py` & `kso_utils-0.2.2/kso_utils/sgu_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/spyfish_utils.py` & `kso_utils-0.2.2/kso_utils/spyfish_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/video_reader.py` & `kso_utils-0.2.2/kso_utils/video_reader.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/widgets.py` & `kso_utils-0.2.2/kso_utils/widgets.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/yolo_utils.py` & `kso_utils-0.2.2/kso_utils/yolo_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/zenodo_utils.py` & `kso_utils-0.2.2/kso_utils/zenodo_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/kso_utils/zooniverse_utils.py` & `kso_utils-0.2.2/kso_utils/zooniverse_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.1/pyproject.toml` & `kso_utils-0.2.2/pyproject.toml`
...
### Comparing `kso_utils-0.2.1/setup.py` & `kso_utils-0.2.2/setup.py`
...
### Comparing `kso_utils-0.2.1/PKG-INFO` & `kso_utils-0.2.2/PKG-INFO`
...
@@ -23,15 +23,15 @@
 ...
 Requires-Dist: ipyfilechooser (==0.4.4)
 Requires-Dist: ipysheet (==0.4.4)
 Requires-Dist: ipython (==8.11.0)
 Requires-Dist: ipywidgets (==7.7.2)
 Requires-Dist: jupyter-bbox-widget (==0.5.0)
 Requires-Dist: natsort (==8.1.0)
-Requires-Dist: opencv-python (==4.5.4.60)
+Requires-Dist: opencv-python (==4.6.0.66)
 Requires-Dist: pandas (==1.5.3)
 Requires-Dist: panoptes-client (==1.6.0)
