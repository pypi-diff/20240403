# Comparing `tmp/pyscreeps-arena-0.1.7.tar.gz` & `tmp/pyscreeps-arena-0.1.8.tar.gz`
...
## Comparing `pyscreeps-arena-0.1.7.tar` & `pyscreeps-arena-0.1.8.tar`
...
### Comparing `pyscreeps-arena-0.1.7/PKG-INFO` & `pyscreeps-arena-0.1.8/PKG-INFO`
...
### Comparing `pyscreeps-arena-0.1.7/pyscreeps_arena/__init__.py` & `pyscreeps-arena-0.1.8/pyscreeps_arena/__init__.py`

 * *Files identical despite different names*

### Comparing `pyscreeps-arena-0.1.7/pyscreeps_arena.egg-info/PKG-INFO` & `pyscreeps-arena-0.1.8/pyscreeps_arena.egg-info/PKG-INFO`
...
### Comparing `pyscreeps-arena-0.1.7/setup.py` & `pyscreeps-arena-0.1.8/setup.py`
