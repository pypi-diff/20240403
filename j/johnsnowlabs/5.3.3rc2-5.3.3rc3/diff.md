# Comparing `tmp/johnsnowlabs-5.3.3rc2.tar.gz` & `tmp/johnsnowlabs-5.3.3rc3.tar.gz`
...
### Comparing `johnsnowlabs-5.3.3rc2/PKG-INFO` & `johnsnowlabs-5.3.3rc3/PKG-INFO`
...
### Comparing `johnsnowlabs-5.3.3rc2/johnsnowlabs/py_models/install_info.py` & `johnsnowlabs-5.3.3rc3/johnsnowlabs/py_models/install_info.py`
...
+./johnsnowlabs/auto_install/docker/build/base_dockerfile
 ...
 docker/johnsnowlabs_fastapi/Dockerfile
 docker/johnsnowlabs_fastapi/README.md
 docker/johnsnowlabs_fastapi/docker-compose.yaml
 docker/johnsnowlabs_fastapi/fastapi_app.py
 docker/johnsnowlabs_fastapi/license.json
...
+johnsnowlabs/serve.py
 ...
 johnsnowlabs/viz.py
 johnsnowlabs.egg-info/PKG-INFO
 johnsnowlabs.egg-info/SOURCES.txt
 johnsnowlabs.egg-info/dependency_links.txt
 johnsnowlabs.egg-info/requires.txt
@@ -39,14 +41,21 @@
...
### Comparing `johnsnowlabs-5.3.3rc2/notebooks/create_databricks_cluster.ipynb` & `johnsnowlabs-5.3.3rc3/notebooks/create_databricks_cluster.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/notebooks/create_emr_cluster.ipynb` & `johnsnowlabs-5.3.3rc3/notebooks/create_emr_cluster.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/notebooks/databricks_endpoints_tutorial.ipynb` & `johnsnowlabs-5.3.3rc3/notebooks/databricks_endpoints_tutorial.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/notebooks/databricks_model_marketplace.ipynb` & `johnsnowlabs-5.3.3rc3/notebooks/databricks_model_marketplace.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/notebooks/haystack_with_johnsnowlabs.ipynb` & `johnsnowlabs-5.3.3rc3/notebooks/haystack_with_johnsnowlabs.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/notebooks/langchain_with_johnsnowlabs.ipynb` & `johnsnowlabs-5.3.3rc3/notebooks/langchain_with_johnsnowlabs.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/notebooks/parameterized_nb_example.ipynb` & `johnsnowlabs-5.3.3rc3/notebooks/parameterized_nb_example.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/notebooks/setup_glue_notebook.ipynb` & `johnsnowlabs-5.3.3rc3/notebooks/setup_glue_notebook.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/setup_johnsnowlabs.py` & `johnsnowlabs-5.3.3rc3/setup_johnsnowlabs_for_databricks.py`
...
### Comparing `johnsnowlabs-5.3.3rc2/setup_johnsnowlabs_for_databricks.py` & `johnsnowlabs-5.3.3rc3/setup_johnsnowlabs.py`
...
### Comparing `johnsnowlabs-5.3.3rc2/tests/auto_install.py` & `johnsnowlabs-5.3.3rc3/tests/auto_install.py`
...
### Comparing `johnsnowlabs-5.3.3rc2/tests/backward_compat.py` & `johnsnowlabs-5.3.3rc3/tests/backward_compat.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/databricks/db_infos_test.py` & `johnsnowlabs-5.3.3rc3/tests/databricks/db_infos_test.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/databricks/db_test_utils.py` & `johnsnowlabs-5.3.3rc3/tests/databricks/db_test_utils.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/databricks/endpoint_tests.py` & `johnsnowlabs-5.3.3rc3/tests/databricks/endpoint_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/databricks/hdfs_tests.py` & `johnsnowlabs-5.3.3rc3/tests/databricks/hdfs_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/databricks/install_tests.py` & `johnsnowlabs-5.3.3rc3/tests/databricks/install_tests.py`
...
### Comparing `johnsnowlabs-5.3.3rc2/tests/databricks/parameterized_nb_example.ipynb` & `johnsnowlabs-5.3.3rc3/tests/databricks/parameterized_nb_example.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/databricks/sample.ipynb` & `johnsnowlabs-5.3.3rc3/tests/databricks/sample.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/databricks/submit_tests.py` & `johnsnowlabs-5.3.3rc3/tests/databricks/submit_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/file_models.py` & `johnsnowlabs-5.3.3rc3/tests/file_models.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/install.py` & `johnsnowlabs-5.3.3rc3/tests/install.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/jsl_dependency_resolver.py` & `johnsnowlabs-5.3.3rc3/tests/jsl_dependency_resolver.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/jsl_secrets.py` & `johnsnowlabs-5.3.3rc3/tests/jsl_secrets.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/llm_frameworks/test_haystack.py` & `johnsnowlabs-5.3.3rc3/tests/llm_frameworks/test_haystack.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/llm_frameworks/test_langchain.py` & `johnsnowlabs-5.3.3rc3/tests/llm_frameworks/test_langchain.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/markdown_tests.py` & `johnsnowlabs-5.3.3rc3/tests/markdown_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/notebook_tests.py` & `johnsnowlabs-5.3.3rc3/tests/notebook_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/spark_session.py` & `johnsnowlabs-5.3.3rc3/tests/spark_session.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs-5.3.3rc2/tests/venv_wrapper_tests.py` & `johnsnowlabs-5.3.3rc3/tests/venv_wrapper_tests.py`
