# Comparing `tmp/spice_rack-0.3.3.tar.gz` & `tmp/spice_rack-0.3.4.tar.gz`
...
### Comparing `spice_rack-0.3.3/src/spice_rack/_bases/__init__.py` & `spice_rack-0.3.4/src/spice_rack/_bases/__init__.py`
