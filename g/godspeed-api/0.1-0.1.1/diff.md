# Comparing `tmp/godspeed_api-0.1.tar.gz` & `tmp/godspeed_api-0.1.1.tar.gz`
...
## Comparing `godspeed_api-0.1.tar` & `godspeed_api-0.1.1.tar`
...
### Comparing `godspeed_api-0.1/LICENSE` & `godspeed_api-0.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `godspeed_api-0.1/PKG-INFO` & `godspeed_api-0.1.1/PKG-INFO`
...
### Comparing `godspeed_api-0.1/godspeed_api/api.py` & `godspeed_api-0.1.1/godspeed_api/api.py`
...
### Comparing `godspeed_api-0.1/godspeed_api.egg-info/PKG-INFO` & `godspeed_api-0.1.1/godspeed_api.egg-info/PKG-INFO`
...
### Comparing `godspeed_api-0.1/setup.py` & `godspeed_api-0.1.1/setup.py`
