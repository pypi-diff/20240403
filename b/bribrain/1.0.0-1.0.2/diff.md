# Comparing `tmp/bribrain-1.0.0.tar.gz` & `tmp/bribrain-1.0.2.tar.gz`
...
+gzip compressed data, was "dist/bribrain-1.0.2.tar", last modified: Wed Apr  3 07:43:07 2024, max compression
```

## Comparing `bribrain-1.0.0.tar` & `bribrain-1.0.2.tar`
...
+drwxr-xr-x   0 cdsw      (8536) cdsw      (8536)        0 2024-04-03 07:43:07.000000 bribrain-1.0.2/
+drwxr-xr-x   0 cdsw      (8536) cdsw      (8536)        0 2024-04-03 07:43:07.000000 bribrain-1.0.2/bribrain/
+-rwx------   0 cdsw      (8536) cdsw      (8536)       90 2024-03-20 04:25:35.000000 bribrain-1.0.2/bribrain/__init__.py
+-rwx------   0 cdsw      (8536) cdsw      (8536)     2456 2024-03-14 14:03:41.000000 bribrain-1.0.2/bribrain/config.py
+-rwx------   0 cdsw      (8536) cdsw      (8536)     4330 2024-04-03 02:49:31.000000 bribrain-1.0.2/bribrain/function.py
+-rwx------   0 cdsw      (8536) cdsw      (8536)    80247 2024-04-03 03:09:21.000000 bribrain-1.0.2/bribrain/ingestion.py
+-rwx------   0 cdsw      (8536) cdsw      (8536)    16578 2024-04-03 07:30:18.000000 bribrain-1.0.2/bribrain/load.py
+drwxr-xr-x   0 cdsw      (8536) cdsw      (8536)        0 2024-04-03 07:43:07.000000 bribrain-1.0.2/bribrain.egg-info/
+-rw-r--r--   0 cdsw      (8536) cdsw      (8536)      460 2024-04-03 07:43:06.000000 bribrain-1.0.2/bribrain.egg-info/PKG-INFO
+-rw-r--r--   0 cdsw      (8536) cdsw      (8536)      267 2024-04-03 07:43:06.000000 bribrain-1.0.2/bribrain.egg-info/SOURCES.txt
+-rw-r--r--   0 cdsw      (8536) cdsw      (8536)        1 2024-04-03 07:43:06.000000 bribrain-1.0.2/bribrain.egg-info/dependency_links.txt
+-rw-r--r--   0 cdsw      (8536) cdsw      (8536)       40 2024-04-03 07:43:06.000000 bribrain-1.0.2/bribrain.egg-info/requires.txt
+-rw-r--r--   0 cdsw      (8536) cdsw      (8536)        9 2024-04-03 07:43:06.000000 bribrain-1.0.2/bribrain.egg-info/top_level.txt
+-rwx------   0 cdsw      (8536) cdsw      (8536)      647 2024-04-03 07:42:52.000000 bribrain-1.0.2/setup.py
+-rw-r--r--   0 cdsw      (8536) cdsw      (8536)      460 2024-04-03 07:43:07.000000 bribrain-1.0.2/PKG-INFO
+-rw-r--r--   0 cdsw      (8536) cdsw      (8536)       38 2024-04-03 07:43:07.000000 bribrain-1.0.2/setup.cfg
```

### Comparing `bribrain-1.0.0/bribrain/config.py` & `bribrain-1.0.2/bribrain/config.py`

 * *Files identical despite different names*

### Comparing `bribrain-1.0.0/bribrain/ingestion.py` & `bribrain-1.0.2/bribrain/ingestion.py`
...
### Comparing `bribrain-1.0.0/bribrain/load.py` & `bribrain-1.0.2/bribrain/load.py`
...
### Comparing `bribrain-1.0.0/setup.py` & `bribrain-1.0.2/setup.py`
