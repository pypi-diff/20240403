# Comparing `tmp/bo_slf-1.0.3.tar.gz` & `tmp/bo_slf-1.0.4.tar.gz`
...
## Comparing `bo_slf-1.0.3.tar` & `bo_slf-1.0.4.tar`
...
### Comparing `bo_slf-1.0.3/LICENSE.txt` & `bo_slf-1.0.4/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `bo_slf-1.0.3/PKG-INFO` & `bo_slf-1.0.4/PKG-INFO`
...
### Comparing `bo_slf-1.0.3/bo_slf.egg-info/PKG-INFO` & `bo_slf-1.0.4/bo_slf.egg-info/PKG-INFO`
...
### Comparing `bo_slf-1.0.3/setup.py` & `bo_slf-1.0.4/setup.py`
